...
describe "testing items class" do
  ...
  it "should return the total tax for the item which is  imported but not exempted" do
    item1 = Item.new("beverages",10,true)
